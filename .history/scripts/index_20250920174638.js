...
x = setInterval(function () {
  ...
  if (dist < 0 || dist > day) {
    ...
    console.log(gift.style);
    gift.style.width = parseInt(gift.style.width) * window.devicePixelRatio + 'px';
    gift.style.height = Math.floor(parseInt(gift.style.height) * window.devicePixelRatio) + 'px';
