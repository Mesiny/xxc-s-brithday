...
x = setInterval(function () {
  ...
  if (dist < 0 || dist > day) {
    ...
    giftbox.style.width = parseInt(parseInt(giftbox.style.width) * window.devicePixelRatio) + 'px';
    giftbox.style.height = parseInt(parseInt(giftbox.style.height) * window.devicePixelRatio) + 'px';
